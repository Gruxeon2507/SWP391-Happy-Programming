...
const AllCourses = () => {
    ...
    const getPageAllCourses = (
        ...
        CourseServices.getPageAllCoursesV2(
            categoryIds,
            searchText,
            pageNumber,
            pageSize,
    ...
    useEffect(() => {
        ...
        getPageAllCourses(checked, searchText, currentPage - 1, sizePerPage, sortField, sortOrder)

    }, [checked, searchText, sortField, sortOrder, currentPage]);
